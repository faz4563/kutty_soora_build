...
switch ($method) {
    ...
    case 'POST':
        ...
        $dimensions = isset($data['dimensions']) ? trim($data['dimensions']) : '';
        ...
        try {
            $stmt = $pdo->prepare("
                INSERT INTO products (
                    ...
                    weight, dimensions, tags, image_url
                ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
            ");
            
            $stmt->execute([
                $name, $description, $price, $category, $stock, $brand, $sku,
                $weight, $dimensions, $tags, $imageUrl
            ]);
    ...
    case 'PUT':
        ...
        $allowedFields = ['name', 'description', 'price', 'category', 'stock', 'brand', 'sku', 'weight', 'dimensions', 'tags', 'image_url'];
