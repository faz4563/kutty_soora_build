...
error_log('Cart - No user_id found in token payload');
    ...
    // SECURITY/CORRECTNESS: build base URL from the request so it works in
    // both local dev (e.g. http://127.0.0.1:5500/backend) and production.
